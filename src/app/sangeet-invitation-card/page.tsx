...
const HISTORY_KEY = "Sangeet-card-history";
...
export default function SangeetInvitationCard() {
  ...
  const [venue, setVenue] = useState("Grand Ballroom, Mumbai");
  const [greeting, setGreeting] = useState("Sangeet Ceremony");
  ...
  // Sync document title
  useEffect(() => {
    document.title = "Free Sangeet Ceremony Invitation Card — No Signup | desidesign.me";
  }, []);
  ...
  useEffect(() => {
    if (!prevHasImage.current && generatedImage && !sessionStorage.getItem("Sangeet_card_waitlist_shown")) {
      sessionStorage.setItem("Sangeet_card_waitlist_shown", "1");
  ...
  function downloadImage() {
    ...
    link.download = `Sangeet-invitation-card-${styleId}.png`;
    link.click();
  }
    ...
    <main className="min-h-screen bg-[#FFF8E7]">
      ...
      <header className="sticky top-0 z-50 bg-white border-b border-[#A91D21]">
        <div className="max-w-7xl mx-auto px-4 h-14 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/Sangeet-ceremony-invitation" className="text-sm font-semibold text-[#E69C3B] hover:text-[#EA812E] transition-colors">
              Sangeet Studio
            </Link>
      ...
      <div className="max-w-7xl mx-auto px-4 pt-6">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 mb-2">
          <div className="flex items-center gap-2 px-4 py-2.5 bg-[#FFF8E7] border border-[#A91D21] rounded-lg">
            ...
            <span className="text-xs font-medium text-[#6C0000]">Golden Sangeet theme — no signup required</span>
          </div>
          <div className="flex items-center gap-2 px-4 py-2.5 bg-[#FFF8E7] border border-[#A91D21] rounded-lg">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 lg:grid lg:grid-cols-[340px_1fr] lg:gap-8">
        ...
        <aside className="space-y-6">
          ...
          <div>
            <p className="text-xs font-bold tracking-widest text-[#E69C3B] mb-1">Sangeet INVITATION CARD MAKER</p>
            <h1 className="text-xl font-bold text-[#6C0000] mb-2">Free Sangeet Ceremony Invitation Card — No Signup</h1>
            <p className="text-sm text-[#6C0000] leading-relaxed">
              Create beautiful golden Sangeet ceremony invitation cards in seconds. Choose an Indian wedding style, add your names and venue, download instantly.
            </p>
          </div>
          ...
          <section>
            ...
            <div className="space-y-3">
              ...
              <label className="block">
                <span className="text-xs font-medium text-[#6C0000] mb-1 block">Sangeet Ceremony Date</span>
                <input
                  type="text"
                  value={dateText}
          ...
          <section className="p-4 bg-[#FFF8E7] border border-[#A91D21] rounded-lg text-center">
            <p className="text-sm font-medium text-[#6C0000] mb-3">
              Want HD print-ready Sangeet cards? Join the waitlist — we&apos;ll notify you first.
            </p>
            <button
          ...
          {generatedImage ? (
            <>
              <div className="relative w-full max-w-md aspect-[5/7] rounded-2xl overflow-hidden shadow-2xl bg-white">
                ...
                <img src={generatedImage} alt="Sangeet ceremony invitation preview" className="w-full h-full object-cover" />
            ...
            <div className="w-full max-w-md aspect-[5/7] rounded-2xl bg-[#FFF8E7] border-2 border-dashed border-[#A91D21] flex items-center justify-center text-[#6C0000]">
              <p className="text-center px-8">
                Pick a style, personalize your details, and click <strong>Generate Free Preview</strong> to see your Sangeet invitation card.
              </p>
            </div>
          )}
        </section>
      ...
      <section className="max-w-4xl mx-auto px-4 py-8">
        <div className="p-6 bg-[#FFF8E7] rounded-2xl text-center border border-[#A91D21]">
          <p className="text-[#6C0000] font-medium mb-3">
            Want more Sangeet design options? Try our full Sangeet Studio with Bollywood, dhol, and mandala styles.
          </p>
          <a
            href="/Sangeet-ceremony-invitation"
